...
function get_region_structure_GB() : array
{
    return [
        ...
        'North East' => ['Darlington' => true, 'Middlesbrough' => true, 'Hartlepool' => true, 'Stockton-on-Tees' => true, 'Redcar and Cleveland' => true, 'Northumberland' => true, 'Tyne and Wear' => true, 'County Durham' => true],
        'North West' => ['Cheshire' => true, 'Cumbria' => true, 'Greater Manchester' => true, 'Lancashire' => true, 'Merseyside' => true],
        'Yorkshire and the Humber' => ['York' => true, 'Kingston upon Hull' => true, 'South Yorkshire' => true, 'West Yorkshire' => true, 'North Yorkshire' => true, 'East Riding of Yorkshire' => true],
        'East Midlands' => ['North Lincolnshire' => true, 'North East Lincolnshire' => true, 'Derbyshire' => true, 'Nottinghamshire' => true, 'Lincolnshire' => true, 'Leicestershire' => true, 'Rutland' => true, 'Northamptonshire' => true],
        'West Midlands' => ['Hereford and Worcester' => true, 'Shropshire' => true, 'Staffordshire' => true, 'Warwickshire' => true, 'West Midlands county' => true],
        'East' => ['Bedfordshire' => true, 'Cambridgeshire' => true, 'Essex' => true, 'Hertfordshire' => true, 'Norfolk' => true, 'Peterborough' => true, 'Suffolk' => true],
        'South East' => ['Brighton and Hove' => true, 'Portsmouth' => true, 'Southampton' => true, 'Milton Keynes' => true, 'Berkshire' => true, 'Buckinghamshire' => true, 'East Sussex' => true, 'Hampshire' => true, 'Isle of Wight' => true, 'Kent' => true, 'Oxfordshire' => true, 'Surrey' => true, 'West Sussex' => true],
        'South West' => ['Bath and North East Somerset' => true, 'South Gloucestershire' => true, 'North Somerset' => true, 'Bournemouth' => true, 'Poole' => true, 'Somerset' => true, 'Bristol' => true, 'Gloucestershire' => true, 'Wiltshire' => true, 'Dorset' => true, 'Devon' => true, 'Cornwall' => true],
        'London' => ['Central London and West End (WC, EC, W, SW)' => true, 'North London (N, EN)' => true, 'East London (E, IG, RM)' => true, 'South East London (SE, BR, DA, TN)' => true, 'South West London (SW, CR, KT, SM, TW)' => true, 'West London (W)' => true, 'North West London (NW, HA, UB)' => true],
    ];
}
