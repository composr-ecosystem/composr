...
function string_scan($lang, $do_guessing = false, $only_exists = true)
{
    ...
    $lang_strings_admin_initial = array_map('trim', explode("\n", trim('
        ...
        UPLOAD_TO
        CMD_CLOUD_FS_INITIALISE_HELP
        CMD_CLOUD_FS_INITIALISE_HELP_Y
        REMOTE_STORAGE_DUPLICATION_ISSUE
        REMOTE_STORAGE_OPERATIONS_DRY_RUN
        REMOTE_STORAGE_OPERATIONS_REAL
