...
class Hook_search_catalogue_entries extends FieldsSearchHook
{
    ...
    public function ajax_tree()
    {
        ...
        if ($catalogue_name == '') {
            ...
            return do_template('FORM_SCREEN', array('_GUID' => '517bb62fcb7a69488b94ee77c486e530', 'TARGET' => '_self', 'GET' => true, 'SKIP_WEBSTANDARDS' => true, 'HIDDEN' => $hidden, 'TITLE' => $title, 'TEXT' => '', 'URL' => $post_url, 'FIELDS' => $fields, 'SUBMIT_ICON' => 'buttons__search', 'SUBMIT_NAME' => $submit_name));
        }
