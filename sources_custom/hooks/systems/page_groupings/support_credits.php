...
class Hook_page_groupings_support_credits
{
    ...
    {
        return array(
            array('audit', 'menu/_generic_admin/tool', array('outstanding_credits', array(), get_page_zone('outstanding_credits', false, 'adminzone')), do_lang_tempcode('customers:UNSPENT_SUPPORT_CREDITS')),
