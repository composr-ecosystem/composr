...
class Hook_addon_registry_less
{
    ...
    public function get_file_list()
    {
        return [
            ...
            'sources_custom/ILess/index.html',
            'sources_custom/ILess/Cache/index.html',
            'sources_custom/ILess/Exception/index.html',
            'sources_custom/ILess/Importer/index.html',
            'sources_custom/ILess/Node/index.html',
            'sources_custom/ILess/Output/index.html',
            'sources_custom/ILess/OutputFilter/index.html',
            'sources_custom/ILess/Parser/index.html',
            'sources_custom/ILess/SourceMap/index.html',
            'sources_custom/ILess/Visitor/index.html',
            'sources_custom/ILess/Output/.htaccess',
            'sources_custom/ILess/Visitor/.htaccess',
            'sources_custom/ILess/SourceMap/.htaccess',
            'sources_custom/ILess/Node/.htaccess',
            'sources_custom/ILess/OutputFilter/.htaccess',
            'sources_custom/ILess/Exception/.htaccess',
            'sources_custom/ILess/Importer/.htaccess',
