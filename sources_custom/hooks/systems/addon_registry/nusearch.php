...
class Hook_addon_registry_nusearch
{
    ...
    {
        return 'Introduces the Composr fast custom index, which will be a bundled part of the search addon in version 11. Designed to significantly improve the speed of most slow searches. Currently being prototyped on active version 10 sites.';
    }
