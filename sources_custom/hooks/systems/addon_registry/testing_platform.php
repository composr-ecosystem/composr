...
We hope other users will appreciate your efforts and give you some points to reward your work.';
    ...
    public function get_file_list() : array
    {
        return [
            ...
            '_tests/tests/unit_tests/___backups.php',
            '_tests/tests/unit_tests/___bash_parser.php',
            '_tests/tests/unit_tests/___broken_links.php',
            '_tests/tests/unit_tests/___demonstratr.php',
            '_tests/tests/unit_tests/___health_check.php',
            '_tests/tests/unit_tests/___installer.php',
            '_tests/tests/unit_tests/___installer_forum_drivers.php',
            '_tests/tests/unit_tests/___installer_xml_db.php',
            '_tests/tests/unit_tests/___performance.php',
            '_tests/tests/unit_tests/___resource_closing.php',
            '_tests/tests/unit_tests/___resource_fs.php',
            '_tests/tests/unit_tests/___search.php',
            '_tests/tests/unit_tests/___sitemap.php',
            '_tests/tests/unit_tests/__actionlog.php',
            '_tests/tests/unit_tests/__api_cloudinary.php',
            '_tests/tests/unit_tests/__api_confluence.php',
            '_tests/tests/unit_tests/__api_currency.php',
            '_tests/tests/unit_tests/__api_ecommerce_shipping.php',
            '_tests/tests/unit_tests/__api_ecommerce_tax.php',
            '_tests/tests/unit_tests/__api_geocoding.php',
            '_tests/tests/unit_tests/__api_google_safe_browsing.php',
            '_tests/tests/unit_tests/__api_google_search_console.php',
            '_tests/tests/unit_tests/__api_ipstack.php',
            '_tests/tests/unit_tests/__api_moz.php',
            '_tests/tests/unit_tests/__api_transifex.php',
            '_tests/tests/unit_tests/__api_translation.php',
            '_tests/tests/unit_tests/__api_twitter.php',
            '_tests/tests/unit_tests/__api_weather.php',
            ...
            '_tests/tests/unit_tests/__form_to_email.php',
            '_tests/tests/unit_tests/__images.php',
            '_tests/tests/unit_tests/__lang_no_unused.php',
            '_tests/tests/unit_tests/__lang_spelling_epic.php',
            '_tests/tests/unit_tests/__protocol_imap.php',
            '_tests/tests/unit_tests/__special_links.php',
            '_tests/tests/unit_tests/__specsettings_documented.php',
            '_tests/tests/unit_tests/__tasks.php',
            '_tests/tests/unit_tests/__template_previews.php',
            '_tests/tests/unit_tests/__third_party_code.php',
            '_tests/tests/unit_tests/__tutorial_quality.php',
            '_tests/tests/unit_tests/__web_resources.php',
            '_tests/tests/unit_tests/_closed_file.php',
            '_tests/tests/unit_tests/_commandr_fs.php',
            '_tests/tests/unit_tests/_config_options.php',
            '_tests/tests/unit_tests/_cqc__function_sigs.php',
            '_tests/tests/unit_tests/_cqc_adminzone.php',
            '_tests/tests/unit_tests/_cqc_blocks.php',
            '_tests/tests/unit_tests/_cqc_cms.php',
            '_tests/tests/unit_tests/_cqc_cns.php',
            '_tests/tests/unit_tests/_cqc_database.php',
            '_tests/tests/unit_tests/_cqc_forum.php',
            '_tests/tests/unit_tests/_cqc_forumdrivers.php',
            '_tests/tests/unit_tests/_cqc_hooks.php',
            '_tests/tests/unit_tests/_cqc_persistent_caching.php',
            '_tests/tests/unit_tests/_cqc_rest.php',
            '_tests/tests/unit_tests/_cqc_site.php',
            '_tests/tests/unit_tests/_cqc_sources.php',
            '_tests/tests/unit_tests/_cqc_welcome.php',
            '_tests/tests/unit_tests/_critical_error_display.php',
            '_tests/tests/unit_tests/_crypt.php',
            '_tests/tests/unit_tests/_css_file.php',
            ...
            '_tests/tests/unit_tests/_file_type_safelisting.php',
            '_tests/tests/unit_tests/_filter_xml.php',
            '_tests/tests/unit_tests/_http_base.php',
            '_tests/tests/unit_tests/_http_timeouts.php',
            '_tests/tests/unit_tests/_httpauth.php',
            '_tests/tests/unit_tests/_ip_bans.php',
            '_tests/tests/unit_tests/_js_file.php',
            '_tests/tests/unit_tests/_leader_board.php',
            '_tests/tests/unit_tests/_log_refs.php',
            '_tests/tests/unit_tests/_maintenance_codes.php',
            '_tests/tests/unit_tests/_notification_classifications.php',
            '_tests/tests/unit_tests/_oembed.php',
            '_tests/tests/unit_tests/_override_issues.php',
            '_tests/tests/unit_tests/_override_notes_consistency.php',
            '_tests/tests/unit_tests/_overused_globals.php',
            '_tests/tests/unit_tests/_path_references.php',
            '_tests/tests/unit_tests/_phpdoc.php',
            '_tests/tests/unit_tests/_privilege_existence.php',
            '_tests/tests/unit_tests/_rate_limiting.php',
            '_tests/tests/unit_tests/_rootkit_detection.php',
            '_tests/tests/unit_tests/_scripts.php',
            '_tests/tests/unit_tests/_search.php',
            '_tests/tests/unit_tests/_setupwizard.php',
            '_tests/tests/unit_tests/_standard_dir_files.php',
