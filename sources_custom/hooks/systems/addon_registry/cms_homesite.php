...
';
    ...
    public function get_file_list() : array
    {
        return [
            ...
            'cmscore.rdf',
            'data_custom/cms_homesite_web_service.php',
            ...
            'uploads/website_specific/cms_homesite/scripts/addon_manifest.php',
            'uploads/website_specific/cms_homesite/scripts/api.php',
            'uploads/website_specific/cms_homesite/scripts/build_personal_upgrader.php',
            'uploads/website_specific/cms_homesite/scripts/errorservice.php',
            'uploads/website_specific/cms_homesite/scripts/fetch_release_details.php',
            'uploads/website_specific/cms_homesite/scripts/goto_release_notes.php',
            'uploads/website_specific/cms_homesite/scripts/index.html',
            'uploads/website_specific/cms_homesite/scripts/newsletter_join.php',
            'uploads/website_specific/cms_homesite/scripts/testing.php',
            'uploads/website_specific/cms_homesite/scripts/user.php',
            'uploads/website_specific/cms_homesite/scripts/version.php',
            'uploads/website_specific/cms_homesite/upgrades/full/index.html',
            'uploads/website_specific/cms_homesite/upgrades/index.html',
            'uploads/website_specific/cms_homesite/upgrades/make_upgrader.php',
