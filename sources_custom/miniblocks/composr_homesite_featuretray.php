...
if (!addon_installed('composr_homesite')) {
    return do_template('RED_ALERT', ['_GUID' => 'nvs4uiit60bctm7u2ya1bkopk8xkyyyu', 'TEXT' => do_lang_tempcode('MISSING_ADDON', escape_html('composr_homesite'))]);
}
    ...
    'help' => [
        ...
        'skill_based' => [
            ...
            [
                ...
                ['Google Summer of Code', 'If you\'re a student and want to work on Composr for the [url="http://code.google.com/soc/"]Google Summer of Code[/url], please [page="site:tickets:ticket:ticket_type=Partnership"]contact us[/page] and we will work to try and make it happen.'],
