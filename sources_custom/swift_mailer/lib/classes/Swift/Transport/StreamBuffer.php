...
class Swift_Transport_StreamBuffer extends Swift_ByteStream_AbstractFilterableInputStream implements Swift_Transport_IoBuffer
{
    ...
    public function startTLS()
    {
        if (PHP_VERSION_ID >= 50600) {
            ...
            $cryptoType = STREAM_CRYPTO_METHOD_SSLv23_CLIENT; // ChrisG: Changing from original code. STREAM_CRYPTO_METHOD_SSLv23_CLIENT actually means "negotiate any supported SSL/TLS protocol". < PHP 5.6 does not support TLS1.1+ any other way.
        }
