...
class Module_iotds
{
    ...
    {
        $content = do_block('main_multi_content', ['param' => 'iotd', 'pinned' => '', 'zone' => get_zone_name(), 'sort' => 'recent', 'max' => '10', 'no_links' => '1', 'pagination' => '1', 'give_context' => '0', 'include_breadcrumbs' => '0', 'block_id' => 'module', 'guid' => 'module']);
