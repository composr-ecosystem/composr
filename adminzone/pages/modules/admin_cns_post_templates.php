...
class Module_admin_cns_post_templates extends Standard_crud_module
{
    ...
    public function pre_run($top_level = true, $type = null)
    {
        ...
        if ($type == 'browse') {
            ...
            breadcrumb_set_parents(array(array('_SEARCH:admin_cns_forums:browse', do_lang_tempcode('MANAGE_FORUMS')), array('_SELF:_SELF:browse', do_lang_tempcode('POST_TEMPLATES'))));
        } elseif ($type == '_import') {
            breadcrumb_set_parents(array(array('_SEARCH:admin_cns_forums:browse', do_lang_tempcode('MANAGE_FORUMS')), array('_SELF:_SELF:browse', do_lang_tempcode('POST_TEMPLATES')), array('_SELF:_SELF:import', do_lang_tempcode('IMPORT_STOCK_RESPONSES_PT'))));
        } else {
            breadcrumb_set_parents(array(array('_SEARCH:admin_cns_forums:browse', do_lang_tempcode('MANAGE_FORUMS')), array('_SELF:_SELF:browse', do_lang_tempcode('POST_TEMPLATES'))));
        }
