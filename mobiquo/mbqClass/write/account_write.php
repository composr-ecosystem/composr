...
class CMSAccountWrite
{
    ...
    private function lost_password($member_id)
    {
        ...
        log_it('LOST_PASSWORD', strval($member_id), strval($code));
        ...
        require_code('mail');
        mail_wrap(do_lang('LOST_PASSWORD', null, null, null, get_lang($member_id)), $message, array($email), $username, '', '', 3, null, false, null, false, false, false, 'MAIL', true);
