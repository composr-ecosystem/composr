        ...
        if ($id !== null) {
            ...
            if ($or_list != '') {
                ...
                if (!empty($compatible_banners)) {
                    ...
                    $fields->attach(do_template('FORM_SCREEN_FIELD_SPACER', ['_GUID' => '008cd640acc13e51876701415bc8810f', 'SECTION_HIDDEN' => $banners_in_type == [], 'TITLE' => do_lang_tempcode('ACTIONS')]));
