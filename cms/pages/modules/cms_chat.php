...
class Module_cms_chat
{
    ...
    public function moderate_chat_room()
    {
        ...
        foreach ($rows as $myrow) {
            ...
            $_row = [$GLOBALS['FORUM_DRIVER']->member_profile_hyperlink($GLOBALS['FORUM_DRIVER']->get_member_from_username($username), '', false), escape_html($link_date), $message];
    ...
    public function _chat_edit_message()
    {
        ...
        if ($delete == 1) {
            ...
            $map = ['text_colour' => preg_replace('#^\##', '', post_param_string('text_colour')), 'font_name' => post_param_string('fontname')];
