<div class="upload-field inline-block multi-field" data-tpl="formScreenInputUploadMulti" data-tpl-params="{+START,PARAMS_JSON,PLUPLOAD,NAME_STUB,I,FILTER}{_*}{+END}">
