...
<form title="{!PRIMARY_PAGE_FORM}" action="{URL*}" method="post">
	...
	{+START,IF_NON_EMPTY,{ZONES}}
		...
		<div class="content-access-table-wrap"><table class="columned-table results-table responsive-table content-access-table" style="width: {$ADD*,20,{$MULT,5,1}}em">
			<colgroup>
	...
	{+START,LOOP,MODULES}
		...
		<div class="content-access-table-wrap"><table class="columned-table results-table responsive-table content-access-table" style="width: {$ADD*,20,{$MULT,5,{$ADD,1,{PRIVILEGES}}}}em">
			<colgroup>
				<col class="content-access-table-label" />
				<col class="content-access-table-setting" />
