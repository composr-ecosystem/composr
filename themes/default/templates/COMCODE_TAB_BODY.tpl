...
<div aria-labelledby="t-{$GET|*,tab_sets}-{TITLE|*}" role="tabpanel" id="g-{$GET|*,tab_sets}-{TITLE|*}" data-tpl="comcodeTabBody" data-tpl-params="{+START,PARAMS_JSON,block_call_url,TITLE}{_*}{+END}" style="display: {$?,{DEFAULT},block,none}">
