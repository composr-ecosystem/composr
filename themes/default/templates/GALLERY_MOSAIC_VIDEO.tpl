<div class="gallery-mosaic-item is-video" {+START,IF,{$HAS_DELETE_PERMISSION,mid,{SUBMITTER},{$MEMBER},cms_galleries}}data-mass-selectable="1"{+END} data-focus-class="focus-within">
