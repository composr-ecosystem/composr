...
(function ($cms) {
    ...
    function getUploaderSettings(name, pageType, postingFieldName, filter) {
        return {
            ...
            url: '{$FIND_SCRIPT_NOHTTP;,incoming_uploads}' + $cms.keep(true),
            ...
            // Flash settings
            flash_swf_url: $util.rel('data/plupload/Moxie.swf'),

            // Silverlight settings
            silverlight_xap_url: $util.rel('data/plupload/Moxie.xap'),
    ...
    function html5Upload(event, fieldName, files) {
        ...
        files.forEach(function (/**@type { File }*/file) {
            ...
            // Progress display
            fileUpload.file_progress = {
                id: 'progress_' + window.extraAttachmentBase,
                name: file.name
            };
            fileUpload.addEventListener('progress', function (e) {
                html5UploadProgress(e, fieldName);
            });
            ...
            // Send
            xhr.open('POST', '{$FIND_SCRIPT_NOHTTP;,incoming_uploads}' + $cms.keep(true));
