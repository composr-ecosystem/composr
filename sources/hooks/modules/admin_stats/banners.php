    ...
    public function info()
    {
        ...
        return [
            'banner_clicks' => [
                ...
                'filters' => [
                    new CMSStatsDateMonthRangeFilter('banner_clicks__month_range', do_lang_tempcode('DATE_RANGE')),
                    new CMSStatsListFilter('banner_clicks__banner', do_lang_tempcode('BANNER'), $banners),
                    has_geolocation_data() ? new CMSStatsListFilter('banner_clicks__country', do_lang_tempcode('VISITOR_COUNTRY'), find_countries()) : null,
                ],
                'pivot' => new CMSStatsDatePivot('banner_clicks__pivot', $this->get_date_pivots()),
            ],
        ];
    }
