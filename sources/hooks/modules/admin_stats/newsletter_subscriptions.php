        ...
        do {
            ...
            foreach ($rows as $row) {
                ...
                foreach (array_keys($date_pivots) as $pivot) {
                    ...
                    if (!isset($data_buckets['newsletter_subscriptions'][$month][$pivot][$pivot_value])) {
                        $data_buckets['newsletter_subscriptions'][$month][$pivot][$pivot_value] = 0;
                    }
                    $data_buckets['newsletter_subscriptions'][$month][$pivot][$pivot_value]++;
                }
            }
