    ...
    public function info()
    {
        ...
        return [
            'subscriptions' => [
                ...
                'filters' => [
                    new CMSStatsDateMonthRangeFilter('subscriptions__month_range', do_lang_tempcode('DATE_RANGE')),
                ],
                'pivot' => new CMSStatsDatePivot('subscriptions__pivot', $this->get_date_pivots()),
            ],
        ];
    }
        ...
        do {
            ...
            foreach ($rows as $row) {
                ...
                foreach (array_keys($date_pivots) as $pivot) {
                    ...
                    if (!isset($data_buckets['subscriptions'][$month][$pivot][$pivot_value])) {
                        $data_buckets['subscriptions'][$month][$pivot][$pivot_value] = 0;
                    }
                    $data_buckets['subscriptions'][$month][$pivot][$pivot_value]++;
                }
            }
