        ...
        foreach ($rows as $row) {
            ...
            foreach ($rows2 as $row2) {
                ...
                if (!empty($member_id)) {
                    ...
                    $GLOBALS['FORUM_DB']->query_insert('f_poll_votes', ['pv_poll_id' => $id_new, 'pv_member_id' => $member_id, 'pv_answer_id' => $answer, 'pv_ip' => '', 'pv_revoked' => 0, 'pv_date_time' => 0, 'pv_cache_points' => 0]);
                }
            }
