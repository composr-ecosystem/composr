...
class Hook_content_meta_aware_comcode_page
{
    ...
    public function info($zone = null, $get_extended_data = false)
    {
        ...
        return array(
            ...
            'add_url' => ($get_extended_data && function_exists('has_submit_permission') && has_submit_permission('high', get_member(), get_ip_address(), 'cms_comcode_pages')) ? (get_module_zone('cms_comcode_pages') . ':cms_comcode_pages:edit') : null,
