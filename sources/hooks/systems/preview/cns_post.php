...
class Hook_preview_cns_post
{
    ...
    public function run()
    {
        ...
        if (!is_guest($post_owner)) {
            ...
            $poster = do_template('CNS_POSTER_GUEST', array('_GUID' => '9c0ba6198663de96facc7399a08e8281', 'LOOKUP_IP_URL' => $lookup_ip_url, 'POSTER_DETAILS' => $poster_details, 'POSTER_USERNAME' => $poster_username));
        }
