 ...
 * Hook class.
 */
class Hook_notification_escrow_fully_satisfied extends Hook_Notification
{
    /**
    ...
    public function list_handled_codes() : array
    {
        ...
        $list = [];
        $list['escrow_fully_satisfied'] = [do_lang('ACTIVITY'), do_lang('points:NOTIFICATION_TYPE_escrow_fully_satisfied')];
        return $list;
    }
