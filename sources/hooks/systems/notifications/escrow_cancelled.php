 ...
 * Hook class.
 */
class Hook_notification_escrow_cancelled extends Hook_Notification
{
    /**
    ...
    public function list_handled_codes() : array
    {
        ...
        $list = [];
        $list['escrow_cancelled'] = [do_lang('ACTIVITY'), do_lang('points:NOTIFICATION_TYPE_escrow_cancelled')];
        return $list;
    }
