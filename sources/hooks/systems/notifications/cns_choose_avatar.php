 ...
 * Hook class.
 */
class Hook_notification_cns_choose_avatar extends Hook_notification__Staff
{
    /**
    ...
    public function list_handled_codes() : array
    {
        ...
        $list = [];
        $list['cns_choose_avatar'] = [do_lang('MEMBERS'), do_lang('cns:NOTIFICATION_TYPE_cns_choose_avatar')];
        return $list;
    }
}
