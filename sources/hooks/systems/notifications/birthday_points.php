 ...
 * Hook class.
 */
class Hook_notification_birthday_points extends Hook_Notification
{
    /**
    ...
    public function list_handled_codes() : array
    {
        ...
        $list = [];
        $list['birthday_points'] = [do_lang('MEMBERS'), do_lang('points:NOTIFICATION_TYPE_birthday_points')];
        return $list;
    }
