 ...
 * Hook class.
 */
class Hook_notification_escrow_disputed extends Hook_Notification
{
    /**
    ...
    public function list_handled_codes() : array
    {
        ...
        $list = [];
        $list['escrow_disputed'] = [do_lang('ACTIVITY'), do_lang('points:NOTIFICATION_TYPE_escrow_disputed')];
        return $list;
    }
