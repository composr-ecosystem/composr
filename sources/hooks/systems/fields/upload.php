...
class Hook_fields_upload
{
    ...
    public function get_field_inputter($_cf_name, $_cf_description, $field, $actual_value, $new)
    {
        ...
        $ffield = form_input_upload($_cf_name, $cf_description, $input_name, $say_required, ($field['cf_required'] == 1) ? null/*so unlink option not shown*/ : $actual_value, null, true, $filetype_filter);
    ...
    public function inputted_to_field_value($editing, $field, $upload_dir = 'uploads/catalogues', $old_value = null)
    {
        ...
        if (!fractional_edit()) {
            ...
            $temp = get_url($tmp_name . '_url', $tmp_name, $upload_dir, 1, CMS_UPLOAD_ANYTHING);
