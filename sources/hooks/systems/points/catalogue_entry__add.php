...
class Hook_points_catalogue_entry__add
{
    ...
    {
        if (!addon_installed('catalogues') || !addon_installed('points')) {
            return null;
        }

        require_code('points');
        $data = points_ledger_calculate(LEDGER_TYPE_RECEIVED | LEDGER_TYPE_SENT | LEDGER_TYPE_SPENT, $member_id_of, null, ' AND t_type=\'catalogue_entry\' AND t_subtype=\'add\'');
