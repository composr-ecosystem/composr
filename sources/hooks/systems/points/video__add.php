...
class Hook_points_video__add
{
    ...
    {
        if (!addon_installed('galleries') || !addon_installed('points')) {
            return null;
        }

        require_code('points');
        $data = points_ledger_calculate(LEDGER_TYPE_RECEIVED | LEDGER_TYPE_SENT | LEDGER_TYPE_SPENT, $member_id_of, null, ' AND t_type=\'video\' AND t_subtype=\'add\'');
