...
class Hook_points_poll__vote
{
    ...
    {
        if (!addon_installed('points') || !addon_installed('polls')) {
            return null;
        }

        require_code('points');
        $data = points_ledger_calculate(LEDGER_TYPE_RECEIVED | LEDGER_TYPE_SENT | LEDGER_TYPE_SPENT, $member_id_of, null, ' AND t_type=\'poll\' AND t_subtype=\'vote\'');
