...
class Hook_points_news__add
{
    ...
    {
        if (!addon_installed('news') || !addon_installed('points')) {
            return null;
        }

        require_code('points');
        $data = points_ledger_calculate(LEDGER_TYPE_RECEIVED | LEDGER_TYPE_SENT | LEDGER_TYPE_SPENT, $member_id_of, null, ' AND t_type=\'news\' AND t_subtype=\'add\'');
