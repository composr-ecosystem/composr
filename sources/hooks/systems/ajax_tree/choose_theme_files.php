...
class Hook_ajax_tree_choose_theme_files
{
                ...
                default:
                    if (preg_match('#^(<\w+>)$#', $id) != 0) {
                        ...
                        foreach (array_keys($pages) as $page) {
                            ...
                            $description_html = $this->get_comcode_page_details_table($page, $zone, $file_path, $action_log_times);
    ...
    protected function get_template_details_table(string $theme, string $template_file, string $template_file_path, ?array $action_log_times = null) : object
    {
        ...
        return do_template('THEME_TEMPLATE_EDITOR_TEMPLATE_DETAIL', [
            ...
            'FILE' => $template_file,
            'FULL_PATH' => preg_replace('#^' . preg_quote(get_file_base() . '/', '#') . '#', '', $template_file_path),
