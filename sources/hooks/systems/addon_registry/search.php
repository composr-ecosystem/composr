...
class Hook_addon_registry_search
{
    ...
    public function get_file_list() : array
    {
        return [
            ...
            'sources/hooks/systems/config/composr_fast_custom_index__max_post_length.php',
            'sources/hooks/systems/config/composr_fast_custom_index__allow_fuzzy_search.php',
            'sources/hooks/systems/config/composr_fast_custom_index__scale_by_commonality.php',
            'sources/hooks/systems/config/composr_fast_custom_index__use_imprecise_ordering.php',
            'sources/hooks/systems/config/composr_fast_custom_index__do_stemming.php',
            'sources/hooks/systems/config/composr_fast_custom_index__max_ngram_size.php',
            'sources/hooks/systems/config/composr_fast_custom_index__enable.php',
            'sources/hooks/systems/config/composr_fast_custom_index__enable_for_ngrams.php',
            'sources/hooks/systems/config/composr_fast_custom_index__enable_for_filtered.php',
