...
class Hook_health_check_security_hackattack extends Hook_Health_Check
{
    ...
    public function testHackAttacks(int $check_context, bool $manual_checks = false, bool $automatic_repair = false, ?bool $use_test_data_for_pass = null, ?array $urls_or_page_links = null, ?array $comcode_segments = null)
    {
        ...
        $this->assertTrue(($num_failed === null) || ($num_failed < $threshold), 'High hack-attack activity in the last 24 hours; cumulative risk scores at ' . integer_format($num_failed, 0));
    }
