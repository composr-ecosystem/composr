...
function cns_get_pp_rows($limit = 5, $unread = true, $include_inline = true, $time_barrier = null)
{
    ...
    foreach (['t_pt_from', 't_pt_to'] as $pt_target) {
        $query .= 'SELECT t.id AS t_id,t_forum_id,t_cache_first_member_id,t_cache_first_title,t_cache_first_post_id,t_cache_last_time,t_cache_last_member_id,t_cache_last_username,t_description,t_cache_num_posts,t_pt_from,t_pt_to,p.id AS p_id';
        $query .= ' FROM
    ...
    if ($include_inline) {
        ...
        $query .= 'SELECT t.id AS t_id,t_forum_id,t_cache_first_member_id,t_cache_first_title,t_cache_first_post_id,t_cache_last_time,t_cache_last_member_id,t_cache_last_username,t_description,t_cache_num_posts,t_pt_from,t_pt_to,MAX(p.id) AS p_id';
        $query .= ' FROM
