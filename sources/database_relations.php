...
function get_table_purpose_flags() : array
{
    return [
        ...
        'cloud_propagation_dirs' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE,
        'cloud_propagation_files' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE,
        'cloud_propagation_logging' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE,
        'cloud_propagation_rpc' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE_AGGRESSIVE,
...
function get_table_descriptions() : array
{
    return [
        ...
        'cloud_propagation_dirs' => 'Instructions to propagate directory changes across a cloud installation',
        'cloud_propagation_files' => 'Instructions to propagate file changes across a cloud installation',
        'cloud_propagation_logging' => 'Instructions to propagate log lines across a cloud installation',
        'cloud_propagation_rpc' => 'Instructions to propagate RPC commands across a cloud installation',
