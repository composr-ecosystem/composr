...
function get_table_purpose_flags() : array
{
    return [
        ...
        'escrow_logs' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__SUBDATA/*under escrow*/,
        ...
        'points_ledger' => TABLE_PURPOSE__NORMAL | TABLE_PURPOSE__FLUSHABLE | TABLE_PURPOSE__SUBDATA/*under f_members*/,
...
function get_relation_map() : array
{
    return [
        ...
        'points_ledger.linked_to' => 'points_ledger.id',
