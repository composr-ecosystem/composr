        ...
        foreach ($rows as $i => $row) {
            ...
            switch ($content_type) {
                case 'image':
                    ...
                    $file_size = url_is_local($image_url) ? (file_exists(get_file_base() . '/' . rawurldecode($image_url)) ? strval(filesize(get_file_base() . '/' . rawurldecode($image_url))) : '') : '';
