...
class Block_main_gallery_embed
{
    ...
    public function run($map)
    {
        ...
        if ((strpos($cat, '*') !== false || strpos($cat, '>') !== false) && (db_has_subqueries($GLOBALS['SITE_DB']->connection_read)) && (!$GLOBALS['FORUM_DRIVER']->is_super_admin(get_member()))) {
            // Check gallery permissions for "narrow in" functionality...
            ...
            $permissions_where .= ')';
            $extra_where_image .= $permissions_where;
            $extra_where_video .= $permissions_where;
        }
