...
function create_selection_list_event_types(?int $it = null, ?int $updated_since = null) : object
{
    ...
    if ((addon_installed('commandr')) && (has_actual_page_access(get_member(), 'admin_commandr')) && ($first_type !== null) && (!shared_site_install()) && (get_option('allow_adding_commandr_events') == '1')) {
