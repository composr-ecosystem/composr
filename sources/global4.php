...
function _log_it(string $type, ?string $a = null, ?string $b = null, ?int $related_warning_id = null) : ?int
{
    ...
    // Notification
    if ((!get_mass_import_mode()) && ($ADMIN_LOGGING_ON) && (!in_array($type, ['MEMBER_SEARCH', 'VIEW_PROFILE']/*FUDGE: Ideally would be parameter driven for these low-information/high-frequency notification types, but there are only two*/))) {
