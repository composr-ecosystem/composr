...
function _get_timezone_list(bool $translate_for_dst = true) : array
{
    $ret = [
        ...
        'America/Phoenix' => '(UTC-07:00) Creston, Dawson, Dawson Creek, Fort Nelson, Hermosillo, Phoenix, Whitehorse',
        ...
        'Africa/Cairo' => '(UTC+02:00) Blantyre, Bujumbura, Cairo, Gaborone, Harare, Johannesburg, Juba, Kaliningrad, Khartoum, Kigali, Lubumbashi, Lusaka, Maputo, Maseru, Mbabane, Tripoli, Windhoek',
