...
function _get_timezone_list(bool $translate_for_dst = true) : array
{
    $ret = [
        ...
        'America/Los_Angeles' => '(UTC-08:00) Dawson, Los Angeles, Pacific Time (US & Canada), Tijuana, Vancouver, Whitehorse',
        ...
        'America/Phoenix' => '(UTC-07:00) Creston, Dawson Creek, Fort Nelson, Hermosillo, Phoenix',
        ...
        'America/Campo_Grande' => '(UTC-03:00) Campo Grande, Cuiaba',
        ...
        'Africa/Cairo' => '(UTC+02:00) Blantyre, Bujumbura, Cairo, Gaborone, Harare, Johannesburg, Kaliningrad, Khartoum, Kigali, Lubumbashi, Lusaka, Maputo, Maseru, Mbabane, Tripoli, Windhoek',
        ...
        'Europe/Moscow' => '(UTC+03:00) Addis Ababa, Aden, Antananarivo, Asmara, Baghdad, Bahrain, Comoro, Dar es Salaam, Djibouti, Istanbul, Juba, Kampala, Kirov, Kuwait, Mayotte, Minsk, Mogadishu, Moscow, Nairobi, Qatar, Riyadh, Simferopol, Syowa',
        ...
        'Asia/Hong_Kong' => '(UTC+08:00) Beijing, Brunei, Casey, Choibalsan, Hong Kong, Irkutsk, Kuala Lumpur, Kuching, Macau, Makassar, Manila, Perth, Shanghai, Singapore, Taipei, Ulaanbaatar',
        ...
        'Pacific/Tongatapu' => '(UTC+13:00) Enderbury, Fakaofo, Johnston, Tongatapu',
