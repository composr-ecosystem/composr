...
function _get_timezone_list($translate_for_dst = true) : array
{
    $ret = [
        ...
        'America/Anchorage' => '(UTC-09:00) Alaska, Anchorage, Juneau, Metlakatla, Nome, Sitka, Yakutat',
        'Pacific/Gambier' => '(UTC-09:00) Gambier Islands',
        'Pacific/Pitcairn' => '(UTC-08:00) Pitcairn Islands',
        'America/Los_Angeles' => '(UTC-08:00) Baja California, Dawson, Los Angeles, Pacific Time (US & Canada), Tijuana, Vancouver, Whitehorse',
        'America/Chihuahua' => '(UTC-07:00) Chihuahua, La Paz (Mexico), Mazatlan',
        'America/Denver' => '(UTC-07:00) Boise, Cambridge Bay, Denver, Edmonton, Inuvik, Mountain Time (US & Canada), Ojinaga, Yellowknife',
        'America/Phoenix' => '(UTC-07:00) Arizona, Creston, Dawson Creek, Fort Nelson, Hermosillo, Phoenix',
        ...
        'America/Chicago' => '(UTC-06:00) Beulah, Center, Central Time (US & Canada), Chicago, Knox, Matamoros, Menominee, New Salem, Rainy River, Rankin Inlet, Resolute, Tell City, Winnipeg',
        'Pacific/Easter' => '(UTC-05:00) Easter Island',
        'America/Havana' => '(UTC-05:00) Cuba, Havana',
        'America/Atikokan' => '(UTC-05:00) Atikokan, Bogota, Cancun, Cayman, Eirunepe, Guayaquil, Jamaica, Lima, Panama, Quito, Rio Branco',
        'America/New_York' => '(UTC-05:00) Detroit, Eastern Time (US & Canada), Grand Turk, Indiana (East), Indianapolis, Iqaluit, Louisville, Marengo, Monticello, Montreal, Nassau, New York, Nipigon, Pangnirtung, Petersburg, Port-au-Prince, Thunder Bay, Toronto, Vevay, Vincennes, Winamac',
        ...
        'America/Halifax' => '(UTC-04:00) Atlantic Time, Bermuda, Glace Bay, Goose Bay, Halifax, Moncton, Thule',
        'America/St_Johns' => '(UTC-03:30) Newfoundland, St. Johns',
        'America/Santiago' => '(UTC-03:00) Santiago',
        'America/Asuncion' => '(UTC-03:00) Asuncion',
        'America/Campo_Grande' => '(UTC-03:00) Brazil, Campo Grande, Cuiaba',
        'America/Araguaina' => '(UTC-03:00) Araguaina, Bahia, Belem, Buenos Aires, Catamarca, Cayenne, Cordoba, Faukland Islands, Fortaleza, Jujuy, La Rioja, Maceio, Mendoza, Montevideo, Palmer, Paramaribo, Punta Arenas, Recife, Rio Gallegos, Rothera, Salta, San Juan, San Luis, Santarem, Stanley, Tucuman, Ushuaia',
        'America/Godthab' => '(UTC-03:00) Godthab, Greenland',
        'America/Miquelon' => '(UTC-03:00) Miquelon, St. Pierre',
        'America/Sao_Paulo' => '(UTC-02:00) Brasilia, Sao Paulo',
        ...
        'Africa/Algiers' => '(UTC+01:00) Algiers, Bangui, Brazzaville, Douala, Kinshasa, Lagos, Libreville, Luanda, Malabo, Ndjamena, Niamey, Porto-Novo, Tunis, West Central Africa',
        ...
        'Africa/Cairo' => '(UTC+02:00) Blantyre, Bujumbura, Cairo, Gaborone, Harare, Johannesburg, Kaliningrad, Khartoum, Kigali, Lubumbashi, Lusaka, Maputo, Maseru, Mbabane, Pretoria, Tripoli, Windhoek',
        'Europe/Chisinau' => '(UTC+02:00) Chisinau, Syria',
        ...
        'Europe/Moscow' => '(UTC+03:00) Addis Ababa, Aden, Antananarivo, Asmara, Baghdad, Bahrain, Comoro, Dar es Salaam, Djibouti, Istanbul, Juba, Kampala, Kirov, Kuwait, Mayotte, Minsk, Mogadishu, Moscow, Nairobi, Qatar, Riyadh, Simferopol, St. Petersburg, Syowa',
        'Asia/Tehran' => '(UTC+03:30) Tehran',
        'Asia/Dubai' => '(UTC+04:00) Abu Dhabi, Astrakhan, Baku, Dubai, Mahe, Mauritius, Muscat, Port Louis, Reunion, Samara, Saratov, Tbilisi, Ulyanovsk, Volgograd, Yerevan',
        'Asia/Kabul' => '(UTC+04:30) Kabul',
        'Asia/Karachi' => '(UTC+05:00) Aqtau, Aqtobe, Ashgabat, Atyrau, Dushanbe, Ekaterinburg, Islamabad, Karachi, Kerguelen, Maldives, Mawson, Oral, Qyzylorda, Samarkand, Tashkent, Yekaterinburg',
        'Asia/Kolkata' => '(UTC+05:30) Chennai, Colombo, Kolkata, Mumbai, New Delhi, Sri Jayawardenepura',
        ...
        'Asia/Bangkok' => '(UTC+07:00) Bangkok, Barnaul, Christmas, Davis, Hanoi, Ho Chi Minh, Hovd, Jakarta, Krasnoyarsk, Novokuznetsk, Novosibirsk, Phnom Penh, Pontianak, Saigon, Tomsk, Vientiane',
        'Asia/Hong_Kong' => '(UTC+08:00) Beijing, Brunei, Casey, Choibalsan, Chongqing, Harbin, Hong Kong, Irkutsk, Kashgar, Kuala Lumpur, Kuching, Macau, Makassar, Manila, Perth, Shanghai, Singapore, Taipei, Ulaanbaatar',
        'Australia/Eucla' => '(UTC+08:45) Eucla',
        'Asia/Tokyo' => '(UTC+09:00) Chita, Dili, Jayapura, Khandyga, Osaka, Palau, Pyongyang, Sapporo, Seoul, Tokyo, Yakutsk',
        'Australia/Darwin' => '(UTC+09:30) Darwin',
        'Pacific/Guam' => '(UTC+10:00) Brisbane, Chuuk, Dumont d\'Urville, Guam, Lindeman, Port Moresby, Saipan, Truk, Ust-Nera, Vladivostok',
        'Australia/Adelaide' => '(UTC+10:30) Adelaide, Broken Hill',
        'Australia/Lord_Howe' => '(UTC+11:00) Lord Howe Island',
        'Australia/Sydney' => '(UTC+11:00) Canberra, Currie, Hobart, Melbourne, Sydney',
        'Asia/Magadan' => '(UTC+11:00) Bougainville, Efate, Guadalcanal, Kosrae, Macquarie, Magadan, New Caledonia, Norfolk Island, Noumea, Pohnpei, Sakhalin, Solomon Islands, Srednekolymsk',
        ...
        'Pacific/Tongatapu' => '(UTC+13:00) Enderbury, Fakaofo, Johnston, Nuku Alofa, Tongatapu',
