...
function remap_foreign_key_as_portable(array $_table_referenced, $id)
{
    ...
    $commandr_filesystem_hook = convert_software_type_codes('table', $table_referenced, 'commandr_filesystem_hook');

    if ($commandr_filesystem_hook === null) {
        return $id; // No special Resource-fs to tie to, so we'll leave it alone
    }

    $resource_type = convert_software_type_codes('table', $table_referenced, 'content_type');
