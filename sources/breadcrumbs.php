...
function load_breadcrumb_substitutions(array $segments) : array
{
    ...
    if ($substitutions === null) {
        $data = is_file(get_file_base() . '/data_custom/xml_config/breadcrumbs.xml') ? cms_file_get_contents_safe(get_file_base() . '/data_custom/xml_config/breadcrumbs.xml', FILE_READ_LOCK | FILE_READ_BOM) : false;
        if ($data === false) {
