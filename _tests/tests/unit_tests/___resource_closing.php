...
// php _tests/index.php ___resource_closing

/**
 * Composr test case class (unit testing).
 */
class ___resource_closing_test_set extends cms_test_case
{
    protected $files;
    ...
    public function setUp()
    {
        ...
        if (!is_cli()) {
            warn_exit('This test should be run on the command line: php _tests/index.php ___resource_closing.');
        }
