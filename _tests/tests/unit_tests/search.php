...
class search_test_set extends cms_test_case
{
    ...
    public function testOpenSearch()
    {
        ...
        $data = cms_http_request($url, array('cookies' => array(get_session_cookie() => $session_id)));
        ...
        $data = cms_http_request($url, array('convert_to_internal_encoding' => true, 'cookies' => array(get_session_cookie() => $session_id)));
