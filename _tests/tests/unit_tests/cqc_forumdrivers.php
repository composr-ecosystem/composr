...
class cqc_forumdrivers_test_set extends cms_test_case
{
    public function testForumDrivers()
    {
        ...
        $result = http_get_contents(get_base_url() . '/_tests/codechecker/code_quality.php?subdir=sources/forum&api=1', ['convert_to_internal_encoding' => true, 'timeout' => 10000.0]);
