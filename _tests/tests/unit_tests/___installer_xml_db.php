...
// php _tests/index.php ___installer_xml_db
 ...
 */
class ___installer_xml_db_test_set extends cms_test_case
{
    public function setUp()
    {
        ...
        if (!is_cli()) {
            warn_exit('This test should be run on the command line: php _tests/index.php ___installer_xml_db.');
        }
    }
