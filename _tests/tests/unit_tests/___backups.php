...
// php _tests/index.php ___backups

/**
 * Composr test case class (unit testing).
 */
class ___backups_test_set extends cms_test_case
{
    public function testBackup()
    {
        if (!is_cli()) {
            warn_exit('This test should be run on the command line: php _tests/index.php ___backups');
        }
