...
class cqc_forum_test_set extends cms_test_case
{
    public function testForum()
    {
        ...
        $result = http_download_file(get_base_url() . '/_tests/codechecker/code_quality.php?subdir=forum&api=1', null, true, false, 'Composr', null, null, null, null, null, null, null, null, 10000.0);
