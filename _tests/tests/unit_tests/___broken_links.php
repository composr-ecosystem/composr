...
// php _tests/index.php ___broken_links

/**
 * Composr test case class (unit testing).
 */
class ___broken_links_test_set extends cms_test_case
{
    public function setUp()
    {
        ...
        if (!is_cli()) {
            warn_exit('This test should be run on the command line: php _tests/index.php ___broken_links');
        }
