...
// php _tests/index.php ___sitemap

/**
 * Composr test case class (unit testing).
 */
class ___sitemap_test_set extends cms_test_case
{
    protected $sitemap;
    protected $flattened;
    protected $options;
    ...
    public function setUp()
    {
        ...
        if (!is_cli()) {
            warn_exit('This test should be run on the command line: php _tests/index.php ___sitemap.');
        }
